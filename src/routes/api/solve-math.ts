            ...
            messages: [
              {
                role: "system",
                content:
                  "შენ ხარ მათემატიკის მასწავლებელი. მოსწავლე გამოგიგზავნის ფოტოს მათემატიკის ამოცანით. ამოიცანი ამოცანა და ამოხსენი ეტაპობრივად ქართულ ენაზე. გამოიყენე Markdown ფორმატირება: სათაურები, ბულეტები და **გამოკვეთილი** ტექსტი. ბოლოს დაწერე საბოლოო პასუხი გამოკვეთილად.",
              },
              {
                role: "user",
                content: [
